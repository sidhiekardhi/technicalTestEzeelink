...
WebUI.click(findTestObject('testbuah/Page_ezeePasar  Pasar Modern Digital  temanbelanjabaru/span_Buah'))

WebUI.click(findTestObject('testbuah/Page_Produk  ezeePasar  Pasar Modern Digital/img'))
